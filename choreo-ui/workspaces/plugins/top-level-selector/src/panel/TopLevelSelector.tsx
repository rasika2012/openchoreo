...
const Panel: React.FC = () => {
    ...
    const { projectQueryResult, componentQueryResult, componentListQueryResult, projectListQueryResult } = useGlobalState();
    ...
    const componentHome = genaratePath({ orgHandle, projectHandle, componentHandle });
        ...
        >
            ...
            {projectName && (
                <AnimateSlide show={!!projectName} unmountOnExit>
                    ...
                    <TopLevelSelector
                        items={projectList?.items?.map(project => ({ label: project.metadata.name, id: project.metadata.name })) || []}
                        recentItems={[]}
            ...
            {componentName && (
                <AnimateSlide show={!!componentName} unmountOnExit>
                    <TopLevelSelector
                        items={componentList?.items?.map(component => ({ label: component.metadata.name, id: component.metadata.name })) || []}
                        recentItems={[]}

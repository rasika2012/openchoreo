...
exports.StyledToggler = void 0;
const material_1 = require("@mui/material");
exports.StyledToggler = (0, material_1.styled)(material_1.Switch)(({ disabled, theme, size = 'medium', color = 'default', // Changed default to 'default'
 }) => {
    const getColor = () => {
        switch (color) {
            case 'primary':
    ...
    return {
        ...
        '& .MuiSwitch-thumb': {
            ...
            borderRadius: size === 'small' ? theme.spacing(0.75) : theme.spacing(1.25),
        },
        '& .MuiSwitch-track': {
...
//# sourceMappingURL=Toggler.styled.js.map
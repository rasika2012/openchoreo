...
export const StyledNavItemContainer = styled(Box)(({ theme, isSubNavVisible, isExpanded, disabled }) => ({
...
export const StyledSubNavContainer = styled(Box)(({ theme, isSelected }) => ({
    display: 'flex',
...
export const StyledMainNavItemContainer = styled(Box)(({ theme, isExpanded, isSelected, isSubNavVisible }) => ({
    display: 'flex',
    gap: theme.spacing(1),
...
export const StyledMainNavItemContainerWithLink = styled(Link)(({ theme, isSelected, isSubNavVisible }) => ({
    display: 'flex',
    gap: theme.spacing(1),
    background: isSubNavVisible && isSelected
        ? theme.palette.primary.dark
...
export const StyledSubNavItemContainer = styled(Link)(({ theme, isExpanded, isSelected }) => ({
    display: 'flex',
    gap: theme.spacing(1),
...
export const StyledSpinIcon = styled(Box)(({ theme, isSubNavVisible, isExpanded }) => ({
    display: 'flex',
    alignItems: 'center',

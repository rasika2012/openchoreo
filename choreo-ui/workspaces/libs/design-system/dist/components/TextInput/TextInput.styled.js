...
export const StyledTextField = styled(TextField, {
    ...
    '.root': {
        ...
        boxShadow: `0 1px 2px -1px ${alpha(theme.palette.common.black, 0.08)}, 0 -3px 9px 0 ${alpha(theme.palette.common.black, 0.04)} inset`,
        borderRadius: 5,
        '&$multiline': {
            height: 'auto',
            resize: 'auto',
    ...
    '.focused': {
        ...
        borderWidth: 1,
        boxShadow: `0 -3px 9px 0 ${alpha(theme.palette.common.black, 0.04)} inset, 0 0 0 2px ${theme.palette.primary.light}`,
        '&:hover': {
            borderColor: theme.palette.primary.light,
        },
    },

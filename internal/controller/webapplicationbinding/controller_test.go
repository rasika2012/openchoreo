...
var _ = Describe("WebApplicationBinding Controller", func() {
	Context("When reconciling a resource", func() {
		...
		webapplicationbinding := &corev1.WebApplicationBinding{}
		...
		BeforeEach(func() {
			...
			if err != nil && errors.IsNotFound(err) {
				resource := &corev1.WebApplicationBinding{
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance WebApplicationBinding")
